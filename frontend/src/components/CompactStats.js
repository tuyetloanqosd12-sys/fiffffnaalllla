            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1">
                  ...
                  <Tooltip content="Стратегия автоматически покупает NFT по floor цене, когда накопит достаточно ETH из комиссий swap">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1">
                  ...
                  <Tooltip content="NFT сжигаются навсегда, уменьшая общее предложение и повышая ценность оставшихся токенов">
                    <svg className="w-4 h-4 text-gray-400 hover:text-gray-600 cursor-help" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </Tooltip>
