            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1">
                  ...
                  <Tooltip content="Strategy automatically buys NFTs at floor price when enough ETH accumulates from swap fees" position="bottom" maxWidth="380px">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1">
                  ...
                  <Tooltip content="NFTs are permanently burned, reducing total supply and increasing value of remaining tokens" position="bottom" maxWidth="380px">
                    <svg className="w-4 h-4 text-gray-400 hover:text-gray-600 cursor-help" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                  </Tooltip>
