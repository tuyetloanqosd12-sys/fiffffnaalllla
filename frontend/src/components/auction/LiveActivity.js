...
const ActivityItem = ({ icon, label, value }) => {
  ...
  return (
    ...
    >
      ...
      {showTooltip && (
        <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 px-4 py-3 bg-gray-800 text-white text-xs rounded-2xl whitespace-nowrap z-[9999] shadow-2xl leading-relaxed">
          {label}
