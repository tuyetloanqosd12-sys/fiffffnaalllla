        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-200 hover:border-emerald-300 transition-all hover:shadow-md">
            <div className="flex items-start justify-between mb-2">
              <span className="text-sm text-gray-600 font-medium flex items-center gap-1">
                Total Value Locked
                <Tooltip content="Общее количество ETH в казне стратегии, готовое к покупке NFT">
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-200 hover:border-orange-300 transition-all hover:shadow-md">
            <div className="flex items-start justify-between mb-2">
              <span className="text-sm text-gray-600 font-medium flex items-center gap-1">
                NFTs Burned
                <Tooltip content="Количество NFT, удаленных из обращения навсегда. Сжигание уменьшает предложение и повышает ценность оставшихся NFT">
                  <svg className="w-4 h-4 text-gray-400 hover:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </Tooltip>
          ...
          <div className="bg-white rounded-xl p-5 border border-gray-200 hover:border-teal-300 transition-all hover:shadow-md">
            <div className="flex items-start justify-between mb-2">
              <span className="text-sm text-gray-600 font-medium flex items-center gap-1">
                Est. Strategy APY
                <Tooltip content="Расчетная годовая доходность стратегии на основе прибыли от продаж NFT за вычетом затрат на покупку">
                  <svg className="w-4 h-4 text-gray-400 hover:text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </Tooltip>
